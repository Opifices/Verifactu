 ...
 * 
 */
@XmlType(name = "EstadoRegistroSIIType", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/RespuestaConsultaLR.xsd")
@XmlEnum
public enum EstadoRegistroSIIType2 {
    ...
    EstadoRegistroSIIType2(String v) {
        value = v;
    }
    ...
    public static EstadoRegistroSIIType2 fromValue(String v) {
        for (EstadoRegistroSIIType2 c: EstadoRegistroSIIType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
